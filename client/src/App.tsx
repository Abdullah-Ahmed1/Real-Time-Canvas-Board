...
function App() {
    const { rectangles, addRectangle, moveRectangle, setRectangles,deleteRectangle } = useCanvasStore();
    ...
    const handleAdd = () => {
      const rect = { id: uuid(), x: 50, y: 50, width: 100, height: 100, color: "red" };
      addRectangle(rect);
      ...
      <div className="flex flex-col items-center p-4 gap-2">
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={!selectedId}
            className={`px-4 py-2 rounded ${selectedId ? "bg-red-500 text-white" : "bg-gray-300 text-gray-600 cursor-not-allowed"}`}
          >
            Delete Rectangle
          </button>
        </div>
